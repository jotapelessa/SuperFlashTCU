        ...
        Column(
            ...
            when (TutorTab.entries[selectedTabIndex]) {
                ...
                TutorTab.CONSULTATION -> {
                    com.example.ui.components.AiConsultationContent(
                        customQuery = customQuery,
                        onQueryChange = { customQuery = it },
                ...
                TutorTab.BOTTLENECKS -> {
                    com.example.ui.components.AiBottlenecksContent(
                        criticalBottlenecks = criticalBottlenecks,
                        onStudyCriticalCards = onStudyCriticalCards
                    )
                }
            }
        }
